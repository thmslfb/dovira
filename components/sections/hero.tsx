        ...
        <div className="lg:mt-0">
          ...
          >
            <Button
              ...
              size="lg"
              variant="ghost"
              className="py-5 w-full bg-gradient-to-r from-[rgb(120,0,255)] via-[#a855ff] to-[rgb(120,0,255)] text-white font-semibold hover:opacity-95 border-none shadow-lg shadow-[rgb(120,0,255)]/50 transition-all duration-300 relative overflow-hidden cursor-pointer"
            >
              <Link
                href="https://calendly.com/khalidcapron"
                target="_blank"
                rel="noopener noreferrer"
                className="hidden lg:flex lg:items-center lg:justify-center py-4"
              >
                Réserver un appel
              </Link>
            </Button>

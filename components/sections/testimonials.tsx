...
const testimonials = [
  {
    ...
    name: "Jordan Girbon",
    role: "YouTuber",
    avatar: "https://yt3.googleusercontent.com/8ODhz1R1OR5zACZ0b8Dg2z2eaQHEaEXp6sAQtwjgFdDw89cVtNUeK8gcyrv-n4ErUWYN8ILs=s160-c-k-c0x00ffffff-no-rj",
    content: "Travailler avec Dovira a transformé ma communication vidéo. Il livre toujours des montages percutants dans des délais record. Un vrai professionnel !",
    rating: 5,
    featured: true
  },
  {
    ...
    name: "Tomy",
    role: "YouTuber",
    avatar: "https://yt3.googleusercontent.com/4rSXoW6AUEPvWHwyGLNJEO41mweWRdQ4KqFHwbBAYOwIBZJQZkimg558wcz3A2wt8g6xUq9B=s160-c-k-c0x00ffffff-no-rj",
    content: "Un monteur réactif et créatif. Chaque vidéo est parfaitement adaptée à mes objectifs marketing. Je recommande les yeux fermés !",
    rating: 5
  },
  {
    id: 3,
    ...
    content: "Dovira a sublimé mes vidéos en un temps record. La qualité est toujours au rendez-vous. Je recommande !",
    rating: 5
  },
  {
    id: 4,
    ...
    avatar: null,
    content: "Grâce à Dovira, mes formations en ligne ont un rendu professionnel. Mes clients adorent la qualité des montages.",
    rating: 5
  },
  {
    id: 5,
    ...
    avatar: null,
    content: "Des montages de qualité studio à des prix accessibles. Dovira comprend parfaitement mes besoins techniques.",
    rating: 5
  },
  {
    id: 6,
    ...
    avatar: null,
    content: "Montages créatifs et soignés qui collent parfaitement à mon univers. Un travail d'artiste !",
    rating: 5
  }
]
        ...
        <ScrollAnimated delay={0.2}>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {testimonials.filter(t => t.featured).map((testimonial) => (
              <Card key={testimonial.id} className="md:col-span-2 lg:col-span-2 lg:row-span-2 relative bg-[#0f0f0f]/90 backdrop-blur-sm border-[rgb(229,208,255)]/30 hover:shadow-[rgb(229,208,255)]/20 transition-all duration-500 group overflow-hidden p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-1">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <Star key={i} className="size-4 text-[rgb(180,120,255)] fill-[rgb(180,120,255)]" />
                        ))}
                      </div>
                    </div>
            ...
            {testimonials.filter(t => !t.featured).map((testimonial, index) => (
              <Card key={testimonial.id} className={`relative bg-[#0f0f0f]/${80 + index * 2} backdrop-blur-sm border-[rgb(229,208,255)]/${25 + index * 3} hover:shadow-[rgb(229,208,255)]/${12 + index * 2} transition-all duration-${350 + index * 50} group overflow-hidden p-6`}>
                ...
                <CardContent className="h-full p-0 relative z-10">
                  <div className="flex flex-col h-full justify-between gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-1">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <Star key={i} className="size-3 text-[rgb(180,120,255)] fill-[rgb(180,120,255)]" />
                        ))}
                      </div>
                    </div>
